...
- (BOOL)writeContents:(id)contents andAttributes:(nullable NSDictionary<NSFileAttributeKey, id> *)additionalFileAttributes safelyToURL:(NSURL *)url forSaveOperation:(UIDocumentSaveOperation)saveOperation error:(NSError **)outError __TVOS_PROHIBITED;
...
- (nullable NSDictionary<NSFileAttributeKey, id> *)fileAttributesToWriteToURL:(NSURL *)url forSaveOperation:(UIDocumentSaveOperation)saveOperation error:(NSError **)outError __TVOS_PROHIBITED;
