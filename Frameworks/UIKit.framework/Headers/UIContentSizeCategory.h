...
UIKIT_EXTERN BOOL UIContentSizeCategoryIsAccessibilityCategory(UIContentSizeCategory category) API_AVAILABLE(macos(10.14),tvos(11.0),watchos(4.0)) NS_REFINED_FOR_SWIFT;
